...
void setup_scr_scrScan(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrScan, 800, 480);
	...
	lv_obj_set_size(ui->scrScan_contBG, 800, 105);
	...
	lv_obj_set_pos(ui->scrScan_labelTitle, 225, 40);
	lv_obj_set_size(ui->scrScan_labelTitle, 350, 56);
	...
	lv_obj_set_style_text_font(ui->scrScan_labelTitle, &lv_font_montserratMedium_33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrScan_imgScanned, &_example_alpha_516x342);
	lv_img_set_pivot(ui->scrScan_imgScanned, 0,0);
	lv_img_set_angle(ui->scrScan_imgScanned, 0);
	lv_obj_set_pos(ui->scrScan_imgScanned, 40, 105);
	lv_obj_set_size(ui->scrScan_imgScanned, 516, 342);
	...
	lv_obj_set_pos(ui->scrScan_contPanel, 593, 105);
	lv_obj_set_size(ui->scrScan_contPanel, 166, 255);
	...
	lv_obj_set_style_radius(ui->scrScan_contPanel, 14, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrScan_imgIconBright, &_bright_alpha_33x33);
	lv_img_set_pivot(ui->scrScan_imgIconBright, 50,50);
	lv_img_set_angle(ui->scrScan_imgIconBright, 0);
	lv_obj_set_pos(ui->scrScan_imgIconBright, 30, 15);
	lv_obj_set_size(ui->scrScan_imgIconBright, 33, 33);
	...
	lv_img_set_src(ui->scrScan_imgIconHue, &_hue_alpha_30x30);
	lv_img_set_pivot(ui->scrScan_imgIconHue, 50,50);
	lv_img_set_angle(ui->scrScan_imgIconHue, 0);
	lv_obj_set_pos(ui->scrScan_imgIconHue, 101, 17);
	lv_obj_set_size(ui->scrScan_imgIconHue, 30, 30);
	...
	lv_obj_set_pos(ui->scrScan_sliderBright, 43, 67);
	lv_obj_set_size(ui->scrScan_sliderBright, 8, 167);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderBright, 88, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderBright, 88, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderBright, 88, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScan_sliderHue, 113, 67);
	lv_obj_set_size(ui->scrScan_sliderHue, 8, 167);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderHue, 88, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderHue, 88, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderHue, 88, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScan_btnNext, 593, 393);
	lv_obj_set_size(ui->scrScan_btnNext, 166, 65);
	...
	lv_obj_set_style_radius(ui->scrScan_btnNext, 30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrScan_btnNext, &lv_font_montserratMedium_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScan_btnBack, 41, 30);
	lv_obj_set_size(ui->scrScan_btnBack, 58, 56);
	...
	lv_obj_set_style_radius(ui->scrScan_btnBack, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrScan_btnBack, &lv_font_montserratMedium_41, LV_PART_MAIN|LV_STATE_DEFAULT);
