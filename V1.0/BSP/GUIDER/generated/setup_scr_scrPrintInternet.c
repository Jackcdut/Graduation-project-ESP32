...
void setup_scr_scrPrintInternet(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrPrintInternet, 800, 480);
	...
	lv_obj_set_size(ui->scrPrintInternet_contBG, 800, 480);
	...
	lv_img_set_src(ui->scrPrintInternet_imgWave, &_no_internet_alpha_66x65);
	lv_img_set_pivot(ui->scrPrintInternet_imgWave, 50,50);
	lv_img_set_angle(ui->scrPrintInternet_imgWave, 0);
	lv_obj_set_pos(ui->scrPrintInternet_imgWave, 299, 199);
	lv_obj_set_size(ui->scrPrintInternet_imgWave, 65, 66);
	...
	lv_img_set_src(ui->scrPrintInternet_imgCloud, &_cloud_alpha_123x90);
	lv_img_set_pivot(ui->scrPrintInternet_imgCloud, 50,50);
	lv_img_set_angle(ui->scrPrintInternet_imgCloud, 0);
	lv_obj_set_pos(ui->scrPrintInternet_imgCloud, 390, 104);
	lv_obj_set_size(ui->scrPrintInternet_imgCloud, 123, 90);
	...
	lv_obj_set_pos(ui->scrPrintInternet_labelPrompt, 90, 307);
	lv_obj_set_size(ui->scrPrintInternet_labelPrompt, 620, 56);
	...
	lv_obj_set_style_text_font(ui->scrPrintInternet_labelPrompt, &lv_font_montserratMedium_33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrPrintInternet_btnBack, 300, 377);
	lv_obj_set_size(ui->scrPrintInternet_btnBack, 200, 68);
	...
	lv_obj_set_style_radius(ui->scrPrintInternet_btnBack, 33, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrPrintInternet_btnBack, &lv_font_montserratMedium_26, LV_PART_MAIN|LV_STATE_DEFAULT);
