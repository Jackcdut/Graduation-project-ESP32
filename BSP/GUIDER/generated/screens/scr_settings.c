...
void setup_scr_scrSettings(lv_ui *ui)
{
	...
	lv_obj_set_style_text_font(ui->scrSettings_btnMenuBrightness_label, &lv_font_ShanHaiZhongXiaYeWuYuW_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrSettings_btnMenuWifi_label, &lv_font_ShanHaiZhongXiaYeWuYuW_24, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* ========================================
	 * LEFT MENU - SD Card Button (SD卡管理)
	 * ========================================*/
	ui->scrSettings_btnMenuGallery = lv_btn_create(ui->scrSettings_contLeft);
	lv_obj_set_pos(ui->scrSettings_btnMenuGallery, 0, 180);  // 90 + 80 + 10 = 180
	...
	lv_obj_set_style_text_font(ui->scrSettings_btnMenuGallery_label, &lv_font_ShanHaiZhongXiaYeWuYuW_24, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* ========================================
	 * LEFT MENU - Cloud Platform Button (云平台管理)
	 * ========================================*/
	ui->scrSettings_btnMenuCloud = lv_btn_create(ui->scrSettings_contLeft);
	lv_obj_set_pos(ui->scrSettings_btnMenuCloud, 0, 260);  // 180 + 70 + 10 = 260
	...
	lv_obj_set_style_text_font(ui->scrSettings_btnMenuCloud_label, &lv_font_ShanHaiZhongXiaYeWuYuW_24, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* ========================================
	 * LEFT MENU - About Button (关于)
	 * ========================================*/
	ui->scrSettings_btnMenuAbout = lv_btn_create(ui->scrSettings_contLeft);
	lv_obj_set_pos(ui->scrSettings_btnMenuAbout, 0, 340);  // 260 + 70 + 10 = 340
	...
	lv_obj_set_style_text_font(ui->scrSettings_btnMenuAbout_label, &lv_font_ShanHaiZhongXiaYeWuYuW_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	/* ========================================
	 * RIGHT CONTENT - WiFi Panel (高级浅色系设计)
	 * 充分利用右侧区域空间，整齐排版，使用ShanHaiZhongXiaYeWuYuW字体
	 * ========================================*/
	...
	lv_obj_set_style_bg_opa(ui->scrSettings_contWifiPanel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_all(ui->scrSettings_contWifiPanel, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* === 顶部标题区域 (浅色背景，高级感) === */
	lv_obj_t *wifi_top_bar = lv_obj_create(ui->scrSettings_contWifiPanel);
	lv_obj_set_pos(wifi_top_bar, 0, 0);
	lv_obj_set_size(wifi_top_bar, 480, 55);
	lv_obj_set_scrollbar_mode(wifi_top_bar, LV_SCROLLBAR_MODE_OFF);
	lv_obj_clear_flag(wifi_top_bar, LV_OBJ_FLAG_SCROLLABLE);
	lv_obj_set_style_bg_color(wifi_top_bar, lv_color_hex(0xFFFFFF), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(wifi_top_bar, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(wifi_top_bar, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(wifi_top_bar, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(wifi_top_bar, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(wifi_top_bar, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(wifi_top_bar, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(wifi_top_bar, lv_color_hex(0xB0BEC5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(wifi_top_bar, 60, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* WiFi图标 - 蓝色 */
	lv_obj_t *wifi_icon = lv_label_create(wifi_top_bar);
	lv_label_set_text(wifi_icon, LV_SYMBOL_WIFI);
	lv_obj_align(wifi_icon, LV_ALIGN_LEFT_MID, 0, 0);
	lv_obj_set_style_text_color(wifi_icon, lv_color_hex(0x42A5F5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(wifi_icon, &lv_font_montserratMedium_24, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* WiFi标题 - 深灰色文字 */
	ui->scrSettings_labelWifiTitle = lv_label_create(wifi_top_bar);
	lv_label_set_text(ui->scrSettings_labelWifiTitle, "WiFi Networks");
	lv_obj_align(ui->scrSettings_labelWifiTitle, LV_ALIGN_LEFT_MID, 35, 0);
	lv_obj_set_style_text_color(ui->scrSettings_labelWifiTitle, lv_color_hex(0x37474F), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_labelWifiTitle, &lv_font_ShanHaiZhongXiaYeWuYuW_22, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* Scan按钮 - 右上角，蓝色渐变 */
	ui->scrSettings_btnWifiScan = lv_btn_create(wifi_top_bar);
	...
	lv_obj_center(ui->scrSettings_btnWifiScan_label);
	lv_obj_set_size(ui->scrSettings_btnWifiScan, 100, 38);
	lv_obj_align(ui->scrSettings_btnWifiScan, LV_ALIGN_RIGHT_MID, 0, 0);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiScan, lv_color_hex(0x42A5F5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->scrSettings_btnWifiScan, lv_color_hex(0x1E88E5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->scrSettings_btnWifiScan, LV_GRAD_DIR_VER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiScan, lv_color_hex(0x1976D2), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_border_width(ui->scrSettings_btnWifiScan, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->scrSettings_btnWifiScan, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->scrSettings_btnWifiScan, 6, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(ui->scrSettings_btnWifiScan, lv_color_hex(0x42A5F5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->scrSettings_btnWifiScan, 80, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->scrSettings_btnWifiScan_label, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_btnWifiScan_label, &lv_font_ShanHaiZhongXiaYeWuYuW_16, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* === WiFi列表区域 (白色卡片，充分利用空间) === */
	lv_obj_t *wifi_list_card = lv_obj_create(ui->scrSettings_contWifiPanel);
	lv_obj_set_pos(wifi_list_card, 0, 65);
	lv_obj_set_size(wifi_list_card, 480, 190);
	lv_obj_set_scrollbar_mode(wifi_list_card, LV_SCROLLBAR_MODE_OFF);
	lv_obj_clear_flag(wifi_list_card, LV_OBJ_FLAG_SCROLLABLE);
	lv_obj_set_style_bg_color(wifi_list_card, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(wifi_list_card, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(wifi_list_card, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(wifi_list_card, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_all(wifi_list_card, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(wifi_list_card, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(wifi_list_card, lv_color_hex(0xB0BEC5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(wifi_list_card, 60, LV_PART_MAIN|LV_STATE_DEFAULT);

	ui->scrSettings_listWifi = lv_list_create(wifi_list_card);
	lv_obj_set_pos(ui->scrSettings_listWifi, 0, 0);
	lv_obj_set_size(ui->scrSettings_listWifi, 480, 190);
	lv_obj_set_style_bg_opa(ui->scrSettings_listWifi, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->scrSettings_listWifi, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->scrSettings_listWifi, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_all(ui->scrSettings_listWifi, 12, LV_PART_MAIN|LV_STATE_DEFAULT);

	lv_obj_t * btn = lv_list_add_btn(ui->scrSettings_listWifi, LV_SYMBOL_WIFI, "Tap Scan to discover networks");
	lv_obj_set_style_text_color(lv_obj_get_child(btn, 1), lv_color_hex(0x90A4AE), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(lv_obj_get_child(btn, 1), &lv_font_ShanHaiZhongXiaYeWuYuW_16, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* === 底部操作按钮区域 (水平排列，现代设计) === */
	lv_obj_t *wifi_btn_card = lv_obj_create(ui->scrSettings_contWifiPanel);
	lv_obj_set_pos(wifi_btn_card, 0, 265);
	lv_obj_set_size(wifi_btn_card, 480, 55);
	lv_obj_set_scrollbar_mode(wifi_btn_card, LV_SCROLLBAR_MODE_OFF);
	lv_obj_clear_flag(wifi_btn_card, LV_OBJ_FLAG_SCROLLABLE);
	lv_obj_set_style_bg_opa(wifi_btn_card, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(wifi_btn_card, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_all(wifi_btn_card, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* Manual按钮 - 浅蓝色背景，深色文字 */
	ui->scrSettings_btnWifiCustom = lv_btn_create(wifi_btn_card);
	...
	lv_obj_center(ui->scrSettings_btnWifiCustom_label);
	lv_obj_set_size(ui->scrSettings_btnWifiCustom, 225, 48);
	lv_obj_set_pos(ui->scrSettings_btnWifiCustom, 10, 3);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiCustom, lv_color_hex(0xE3F2FD), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiCustom, lv_color_hex(0xBBDEFB), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->scrSettings_btnWifiCustom_label, lv_color_hex(0x1976D2), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_btnWifiCustom_label, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* Disconnect按钮 - 浅红色背景，深红色文字 */
	ui->scrSettings_btnWifiDisconnect = lv_btn_create(wifi_btn_card);
	...
	lv_obj_center(ui->scrSettings_btnWifiDisconnect_label);
	lv_obj_set_size(ui->scrSettings_btnWifiDisconnect, 225, 48);
	lv_obj_set_pos(ui->scrSettings_btnWifiDisconnect, 245, 3);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiDisconnect, lv_color_hex(0xFFEBEE), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiDisconnect, lv_color_hex(0xFFCDD2), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->scrSettings_btnWifiDisconnect_label, lv_color_hex(0xE53935), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_btnWifiDisconnect_label, &lv_font_ShanHaiZhongXiaYeWuYuW_16, LV_PART_MAIN|LV_STATE_DEFAULT);

	/* Spinner for scanning - 居中显示 */
	ui->scrSettings_spinnerWifiScan = lv_spinner_create(ui->scrSettings_contWifiPanel, 1000, 60);
	lv_obj_set_pos(ui->scrSettings_spinnerWifiScan, 215, 140);
	lv_obj_set_size(ui->scrSettings_spinnerWifiScan, 50, 50);
	lv_obj_set_style_arc_color(ui->scrSettings_spinnerWifiScan, lv_color_hex(0x42A5F5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_arc_color(ui->scrSettings_spinnerWifiScan, lv_color_hex(0xE3F2FD), LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->scrSettings_labelAboutTitle, "Graduation Design Project");
	lv_obj_set_pos(ui->scrSettings_labelAboutTitle, 0, 0);
	lv_obj_set_size(ui->scrSettings_labelAboutTitle, 480, 32);
	lv_obj_set_style_text_color(ui->scrSettings_labelAboutTitle, lv_color_hex(0x1565c0), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_labelAboutTitle, &lv_font_ShanHaiZhongXiaYeWuYuW_24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	// 项目名称（副标题）
	lv_obj_t *labelSubtitle = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelSubtitle, "Portable Test System Design for Development and Debugging");
	lv_label_set_long_mode(labelSubtitle, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(labelSubtitle, 0, 32);
	lv_obj_set_size(labelSubtitle, 480, 45);
	lv_obj_set_style_text_color(labelSubtitle, lv_color_hex(0x546e7a), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelSubtitle, &lv_font_ShanHaiZhongXiaYeWuYuW_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(labelSubtitle, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);

	// Author 标签
	lv_obj_t *labelAuthorKey = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelAuthorKey, "Author:");
	lv_obj_set_pos(labelAuthorKey, 0, 82);
	lv_obj_set_style_text_color(labelAuthorKey, lv_color_hex(0x1976d2), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelAuthorKey, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	lv_obj_t *labelAuthorVal = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelAuthorVal, "Ji Shuai");
	lv_obj_set_pos(labelAuthorVal, 100, 82);
	lv_obj_set_style_text_color(labelAuthorVal, lv_color_hex(0x37474f), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelAuthorVal, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	// Student ID 标签
	lv_obj_t *labelIdKey = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelIdKey, "Student ID:");
	lv_obj_set_pos(labelIdKey, 0, 108);
	lv_obj_set_style_text_color(labelIdKey, lv_color_hex(0x1976d2), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelIdKey, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	lv_obj_t *labelIdVal = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelIdVal, "202206010320");
	lv_obj_set_pos(labelIdVal, 100, 108);
	lv_obj_set_style_text_color(labelIdVal, lv_color_hex(0x37474f), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelIdVal, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	// Major 标签
	lv_obj_t *labelMajorKey = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelMajorKey, "Major:");
	lv_obj_set_pos(labelMajorKey, 0, 134);
	lv_obj_set_style_text_color(labelMajorKey, lv_color_hex(0x1976d2), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelMajorKey, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	lv_obj_t *labelMajorVal = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelMajorVal, "Measurement & Control Technology and Instruments");
	lv_label_set_long_mode(labelMajorVal, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(labelMajorVal, 100, 134);
	lv_obj_set_size(labelMajorVal, 380, 40);
	lv_obj_set_style_text_color(labelMajorVal, lv_color_hex(0x37474f), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelMajorVal, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	// College 标签
	lv_obj_t *labelCollegeKey = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelCollegeKey, "College:");
	lv_obj_set_pos(labelCollegeKey, 0, 178);
	lv_obj_set_style_text_color(labelCollegeKey, lv_color_hex(0x1976d2), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelCollegeKey, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	lv_obj_t *labelCollegeVal = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelCollegeVal, "Nuclear Technology and Automation Engineering");
	lv_label_set_long_mode(labelCollegeVal, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(labelCollegeVal, 100, 178);
	lv_obj_set_size(labelCollegeVal, 380, 40);
	lv_obj_set_style_text_color(labelCollegeVal, lv_color_hex(0x37474f), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelCollegeVal, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	// University 标签
	lv_obj_t *labelUniKey = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelUniKey, "University:");
	lv_obj_set_pos(labelUniKey, 0, 222);
	lv_obj_set_style_text_color(labelUniKey, lv_color_hex(0x1976d2), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelUniKey, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	lv_obj_t *labelUniVal = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelUniVal, "Chengdu University of Technology");
	lv_obj_set_pos(labelUniVal, 100, 222);
	lv_obj_set_style_text_color(labelUniVal, lv_color_hex(0x37474f), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelUniVal, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);

	// 项目简介
	lv_obj_t *labelDesc = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(labelDesc, "This system integrates oscilloscope, power supply, DMM, signal generator and wireless debugging functions into a portable device.");
	lv_label_set_long_mode(labelDesc, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(labelDesc, 0, 265);
	lv_obj_set_size(labelDesc, 480, 55);
	lv_obj_set_style_text_color(labelDesc, lv_color_hex(0x607d8b), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(labelDesc, &lv_font_ShanHaiZhongXiaYeWuYuW_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(labelDesc, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);

	// 保留原有的labelAboutContent用于兼容性（隐藏）
	ui->scrSettings_labelAboutContent = lv_label_create(ui->scrSettings_contAboutPanel);
	lv_label_set_text(ui->scrSettings_labelAboutContent, "");
	lv_obj_add_flag(ui->scrSettings_labelAboutContent, LV_OBJ_FLAG_HIDDEN);

	/* ========================================
	 * WiFi Custom Connection Dialog (Initially Hidden)
	 * 高级浅色系设计 - 纯白卡片风格，无黑色背景
	 * ========================================*/
	ui->scrSettings_contWifiDialog = lv_obj_create(ui->scrSettings);
	lv_obj_set_size(ui->scrSettings_contWifiDialog, 400, 310);
	lv_obj_center(ui->scrSettings_contWifiDialog);
	lv_obj_add_flag(ui->scrSettings_contWifiDialog, LV_OBJ_FLAG_HIDDEN);
	
	// 禁止滑动和滚动条
	lv_obj_set_scrollbar_mode(ui->scrSettings_contWifiDialog, LV_SCROLLBAR_MODE_OFF);
	lv_obj_clear_flag(ui->scrSettings_contWifiDialog, LV_OBJ_FLAG_SCROLLABLE);
	...
	lv_obj_set_style_border_width(ui->scrSettings_contWifiDialog, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->scrSettings_contWifiDialog, lv_color_hex(0xE8EEF5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->scrSettings_contWifiDialog, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->scrSettings_contWifiDialog, 30, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(ui->scrSettings_contWifiDialog, lv_color_hex(0x90A4AE), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->scrSettings_contWifiDialog, 80, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_spread(ui->scrSettings_contWifiDialog, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_all(ui->scrSettings_contWifiDialog, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// WiFi图标 - 大号蓝色图标，居中顶部
	lv_obj_t *dialog_wifi_icon = lv_label_create(ui->scrSettings_contWifiDialog);
	lv_label_set_text(dialog_wifi_icon, LV_SYMBOL_WIFI);
	lv_obj_align(dialog_wifi_icon, LV_ALIGN_TOP_MID, 0, 5);
	lv_obj_set_style_text_color(dialog_wifi_icon, lv_color_hex(0x42A5F5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(dialog_wifi_icon, &lv_font_montserratMedium_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// 标题文字 - 深灰色，图标下方
	lv_obj_t *dialog_title = lv_label_create(ui->scrSettings_contWifiDialog);
	lv_label_set_text(dialog_title, "Connect to WiFi");
	lv_obj_align(dialog_title, LV_ALIGN_TOP_MID, 0, 40);
	lv_obj_set_style_text_color(dialog_title, lv_color_hex(0x37474F), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(dialog_title, &lv_font_ShanHaiZhongXiaYeWuYuW_22, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// SSID输入区域 - 浅色背景，圆角设计
	lv_obj_t *ssid_container = lv_obj_create(ui->scrSettings_contWifiDialog);
	lv_obj_set_size(ssid_container, 360, 50);
	lv_obj_align(ssid_container, LV_ALIGN_TOP_MID, 0, 75);
	lv_obj_set_scrollbar_mode(ssid_container, LV_SCROLLBAR_MODE_OFF);
	lv_obj_clear_flag(ssid_container, LV_OBJ_FLAG_SCROLLABLE);
	lv_obj_set_style_bg_color(ssid_container, lv_color_hex(0xF5F7FA), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ssid_container, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ssid_container, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ssid_container, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ssid_container, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ssid_container, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// SSID图标
	lv_obj_t *ssid_icon = lv_label_create(ssid_container);
	lv_label_set_text(ssid_icon, LV_SYMBOL_WIFI);
	lv_obj_align(ssid_icon, LV_ALIGN_LEFT_MID, 0, 0);
	lv_obj_set_style_text_color(ssid_icon, lv_color_hex(0x90A4AE), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ssid_icon, &lv_font_montserratMedium_19, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// SSID textarea - 无边框，融入背景
	ui->scrSettings_textareaSSID = lv_textarea_create(ssid_container);
	lv_obj_set_pos(ui->scrSettings_textareaSSID, 35, 0);
	lv_obj_set_size(ui->scrSettings_textareaSSID, 290, 50);
	lv_textarea_set_text(ui->scrSettings_textareaSSID, "");
	lv_textarea_set_placeholder_text(ui->scrSettings_textareaSSID, "WiFi Name (SSID)");
	lv_textarea_set_one_line(ui->scrSettings_textareaSSID, true);
	lv_obj_set_style_bg_opa(ui->scrSettings_textareaSSID, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->scrSettings_textareaSSID, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->scrSettings_textareaSSID, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_textareaSSID, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->scrSettings_textareaSSID, lv_color_hex(0x37474F), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->scrSettings_textareaSSID, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// Password输入区域 - 浅色背景，圆角设计
	lv_obj_t *pwd_container = lv_obj_create(ui->scrSettings_contWifiDialog);
	lv_obj_set_size(pwd_container, 360, 50);
	lv_obj_align(pwd_container, LV_ALIGN_TOP_MID, 0, 140);
	lv_obj_set_scrollbar_mode(pwd_container, LV_SCROLLBAR_MODE_OFF);
	lv_obj_clear_flag(pwd_container, LV_OBJ_FLAG_SCROLLABLE);
	lv_obj_set_style_bg_color(pwd_container, lv_color_hex(0xF5F7FA), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(pwd_container, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(pwd_container, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(pwd_container, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(pwd_container, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(pwd_container, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// Password图标
	lv_obj_t *pwd_icon = lv_label_create(pwd_container);
	lv_label_set_text(pwd_icon, LV_SYMBOL_EYE_CLOSE);
	lv_obj_align(pwd_icon, LV_ALIGN_LEFT_MID, 0, 0);
	lv_obj_set_style_text_color(pwd_icon, lv_color_hex(0x90A4AE), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(pwd_icon, &lv_font_montserratMedium_19, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// Password textarea - 无边框，融入背景
	ui->scrSettings_textareaPassword = lv_textarea_create(pwd_container);
	lv_obj_set_pos(ui->scrSettings_textareaPassword, 35, 0);
	lv_obj_set_size(ui->scrSettings_textareaPassword, 290, 50);
	lv_textarea_set_text(ui->scrSettings_textareaPassword, "");
	lv_textarea_set_placeholder_text(ui->scrSettings_textareaPassword, "Password");
	...
	lv_obj_set_style_bg_opa(ui->scrSettings_textareaPassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->scrSettings_textareaPassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->scrSettings_textareaPassword, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_textareaPassword, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->scrSettings_textareaPassword, lv_color_hex(0x37474F), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->scrSettings_textareaPassword, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// 按钮区域 - 水平居中排列，现代圆角设计
	// Cancel button - 浅灰色背景，深色文字
	...
	lv_obj_set_size(ui->scrSettings_btnWifiCancel, 170, 50);
	lv_obj_align(ui->scrSettings_btnWifiCancel, LV_ALIGN_TOP_MID, -90, 210);

	lv_obj_set_style_bg_opa(ui->scrSettings_btnWifiCancel, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiCancel, lv_color_hex(0xECEFF1), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiCancel, lv_color_hex(0xCFD8DC), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->scrSettings_btnWifiCancel_label, lv_color_hex(0x546E7A), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_btnWifiCancel_label, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	
	// Connect button - 蓝色渐变，白色文字
	...
	lv_label_set_text(ui->scrSettings_btnWifiConnect_label, "Connect");
	lv_obj_align(ui->scrSettings_btnWifiConnect_label, LV_ALIGN_CENTER, 0, 0);
	lv_obj_set_size(ui->scrSettings_btnWifiConnect, 170, 50);
	lv_obj_align(ui->scrSettings_btnWifiConnect, LV_ALIGN_TOP_MID, 90, 210);

	lv_obj_set_style_bg_opa(ui->scrSettings_btnWifiConnect, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiConnect, lv_color_hex(0x42A5F5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->scrSettings_btnWifiConnect, lv_color_hex(0x1E88E5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->scrSettings_btnWifiConnect, LV_GRAD_DIR_VER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->scrSettings_btnWifiConnect, lv_color_hex(0x1976D2), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_shadow_width(ui->scrSettings_btnWifiConnect, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(ui->scrSettings_btnWifiConnect, lv_color_hex(0x42A5F5), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->scrSettings_btnWifiConnect, 100, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->scrSettings_btnWifiConnect_label, lv_color_hex(0xFFFFFF), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrSettings_btnWifiConnect_label, &lv_font_ShanHaiZhongXiaYeWuYuW_18, LV_PART_MAIN|LV_STATE_DEFAULT);
