...
static void create_activated_panel(lv_obj_t *parent)
{
    ...
    /* ===== 最后同步状态卡片 (100px) - 与设备信息卡片间隔8px ===== */
    s_sync_status_cont = lv_obj_create(s_activated_panel);
    lv_obj_set_size(s_sync_status_cont, lv_pct(100), 100);  /* 高度100px，减小10px */
    ...
    lv_obj_align(s_sync_uploaded_label, LV_ALIGN_TOP_RIGHT, 0, 30);  /* 调整位置 */
    ...
    lv_label_set_text(s_sync_location_label, "Location: --");
    lv_obj_align(s_sync_location_label, LV_ALIGN_TOP_RIGHT, 0, 55);  /* 调整位置 */
    ...
    /* ===== 上传操作区域 - 左右两个白色卡片 (115px) - 与同步卡片间隔8px ===== */
    lv_obj_t *upload_row = lv_obj_create(s_activated_panel);
    lv_obj_set_size(upload_row, lv_pct(100), 115);  /* 增加10px高度: 105+10=115 */
    ...
    lv_obj_set_size(manual_card, lv_pct(48), 110);  /* 增加10px高度: 100+10=110 */
    ...
    lv_obj_set_size(auto_card, lv_pct(48), 110);  /* 增加10px高度: 100+10=110 */
